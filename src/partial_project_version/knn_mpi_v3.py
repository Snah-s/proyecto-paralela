...
if rank == 0:
  ...
  operations_per_distance = 3 * d + 1
  total_distance_operations = n_test * n_train * operations_per_distance
  flops = total_distance_operations / compute_time if compute_time > 0 else 0

  output_path = os.path.join("mpi_results.csv")
  ...
  print("=" * 70)
  print("Parallel KNN with MPI - Version 3")
  print("=" * 70)
